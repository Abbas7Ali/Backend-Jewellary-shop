	   ...
	   <div class="col-sm-6 space_left">
	    <div class="register_1li1l clearfix">
		 ...
		 <select class=" form-control">
			...
			<option value="Afghanisthan"> Australia </option>
			<option value="Afghanisthan"> England </option>
		 </select>
		</div>
	   </div>
	   <div class="col-sm-6 space_right">
	  ...
	  <div class="register_1li1 clearfix">
	   <div class="col-sm-6 space_left">
	    <div class="register_1li1l clearfix">
		 <h5>Company Name</h5>
		 <select class=" form-control">
			<option value="Country"> Your Company </option>
			<option value="India"> India </option>
			<option value="United states"> America </option>
			<option value="Afghanisthan"> Australia </option>
			<option value="Afghanisthan"> England </option>
	   ...
	   <div class="col-sm-6 space_right">
	    <div class="register_1li1l clearfix">
		 <h5>Company Type</h5>
		 <select class=" form-control">
			<option value="Country"> Company Type </option>
			<option value="India"> India </option>
			<option value="United states"> America </option>
			<option value="Afghanisthan"> Australia </option>
			<option value="Afghanisthan"> England </option>
	  ...
	  <div class="register_1li1 clearfix">
	   <div class="col-sm-12 space_all">
	    ...
	    <div class="register_1li1l clearfix">
		 <h5>Contact</h5>
		 <select class=" form-control">
			<option value="Country"> Contact No </option>
			<option value="India"> India </option>
			<option value="United states"> America </option>
			<option value="Afghanisthan"> Australia </option>
			<option value="Afghanisthan"> England </option>
