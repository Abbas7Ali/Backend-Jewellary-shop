...
<div class="header navbar navbar-inverse"> 
    ...
    <div class="navbar-inner">
        ...
        <div class="header-seperation"> 
            ...
            <!-- END MOBILE HEADER -->
            <!-- BEGIN LOGO --> 
            <h4 style="text-align: center; margin-top:20px;"><strong style="color:white">Jeweler CMS Panel</strong></h4>
            <!-- END LOGO --> 
            </div>
                ...
                <div class="chat-toggler">  
                    ...
                    <a href="#">
                        <div class="user-details"> 
                            <div class="username">
                                Ali <span class="bold"> Abbas</span>                                   
                            </div>                      
                        </div> 
                        &nbsp; &nbsp; &nbsp; &nbsp; 
                    </a>    
                    ...
                    <div class="profile-pic"> 
                        <img src="_assets/img/profiles/ali.jpg" alt="" data-src="_assets/img/profiles/ali.jpg" data-src-retina="_assets/img/profiles/ali.jpg" width="35" height="35" /> 
                    </div>  
                    <!-- END PROFILE PICTURE -->                
                </div>
